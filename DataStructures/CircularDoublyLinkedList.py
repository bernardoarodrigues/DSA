# circular doubly linked list in python (self.tail.next = self.head and self.head.prev = self.tail)
print('---> circular doubly linked in python')
...
class DoublyLinkedList:
    ...
    def append(self, value):   # Time: O(1)
        ...
        if self.length == 0:
            ...
            newNode.next = newNode.tail = newNode
        else:
